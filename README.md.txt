...
Install Blender (version 4.x or later).
Enable Python Scripting in Blender:
Open Blender.
...
Open the Avatar Generator Panel:
Navigate to Tools → Avatar Generator in Unity.
Start the API and Generate an Avatar:
...
Retrieve Your Generated Avatars:
